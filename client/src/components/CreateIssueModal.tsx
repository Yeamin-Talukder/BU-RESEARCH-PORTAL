...
const CreateIssueModal: React.FC<CreateIssueModalProps> = ({ open, onOpenChange, onSuccess, journals }) => {
    ...
    useEffect(() => {
        if (selectedJournal) {
            ...
            setFormData(prev => ({ ...prev, volumeId: '' })); // Reset volume on journal change
        } else {
            setVolumes([]);
        }
    }, [selectedJournal]);
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleSubmit} disabled={loading || !formData.volumeId}>
